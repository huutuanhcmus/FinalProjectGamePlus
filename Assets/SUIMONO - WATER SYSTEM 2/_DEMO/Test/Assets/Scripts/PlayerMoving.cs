...
public class PlayerMoving : MonoBehaviour
{
    ...
    public float movement_Speed = 3f;   // di chuyen
    public float gravity = 9.8f;    
    public float rotation_Speed = 0.15f;   // xoay
    ...
    void Move()
    {
        if(Input.GetAxis(Axis.VERTICAL_AXIS) > 0)  // truc y
        {
    ...
    void Rotate()
    {
        ...
        if (Input.GetAxis(Axis.HORIZONTAL_AXIS) < 0)  // truc y
        {
